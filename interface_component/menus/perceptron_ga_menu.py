...
def set_no_generations_pga(value):
    try:
        if value <= 0:
            return dbc.Alert(id='no_generations_0_alert', children='Liczba popkoleń powinna być większa od 0!',
                             color='danger')
...
def set_pop_size_pga(value):
    try:
        if value <= 0:
            return dbc.Alert(id='pop_size_0_alert', children='Liczebność populacji powinna być większa od 0!',
                             color='danger')
